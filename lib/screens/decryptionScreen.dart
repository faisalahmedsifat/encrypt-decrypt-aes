...
class _decryptionPageState extends State<decryptionPage> {
  ...
  Future<File> saveFile1(String file) async {
    ...
    // var fileToDelete = ('$appStorage/${file.split('/').last}');
    var fileName = (file.split('/').last);
    final newfile = ('$appStorage/$fileName');
    final deleteFileName = (_path!.split('/').last);
    final deleteFile = ('$appStorage/$deleteFileName');
    print("delete file: " + deleteFile);
    print("new file: " + newfile);
    final savedFile = (File(file).copy(newfile));
    await File(deleteFile).delete();
    return savedFile;
  }
              ...
              if (_textController.text != null &&
                ...
                try {
                  ...
                  if (count == 1) {
                    ...
                    final newFile = await saveFile1(decFilepath!);
